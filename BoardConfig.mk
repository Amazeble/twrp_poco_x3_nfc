...
TW_INCLUDE_CRYPTO_SW := true
PLATFORM_SECURITY_PATCH := 2099-12-31
VENDOR_SECURITY_PATCH := $(PLATFORM_SECURITY_PATCH)

# FBE/Encryption settings for Android 14+
BOARD_USES_METADATA_PARTITION := true
BOARD_ROOT_EXTRA_FOLDERS += metadata
BOARD_AVB_FECF_SIGNATURE_KEY_STORE_PATH := external/avb/test/data/testkey_rsa2048.pem

# Android 15+ FBE mandatory settings
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := external/avb/test/data/testkey_rsa2048.pem
BOARD_AVB_VBMETA_SYSTEM_ALGORITHM := SHA256_RSA2048
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX := $(PLATFORM_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_SYSTEM_ADD_HASHFS_OFF := true

# Android 16 specific - FDE fully deprecated, stricter AVB
